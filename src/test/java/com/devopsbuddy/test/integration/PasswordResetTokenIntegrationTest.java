...
public class PasswordResetTokenIntegrationTest extends AbstractIntegrationTest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PasswordResetTokenIntegrationTest.class);
    ...
    public void testDeleteToken() throws Exception {
        ...
        LOG.info("delete tokenId : {}",tokenId);
    ...
    private PasswordResetToken createPasswordResetToken(String token, User user, LocalDateTime now) {
        ...
        PasswordResetToken passwordResetToken
                    = new PasswordResetToken(token, user, now, expirationTimeInMinutes);
