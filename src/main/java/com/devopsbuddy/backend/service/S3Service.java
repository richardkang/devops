...
public class S3Service {
    ...
    public String storeProfileImage(MultipartFile uploadedFile, String username)  {
        ...
        try {
            LOG.info(" uploadedFile : {}",uploadedFile.getName());

            if (uploadedFile != null && !uploadedFile.isEmpty()) {
                byte[] bytes = uploadedFile.getBytes();
                LOG.info(" tmpImageStoredFolder : {}",tempImageStore);
    ...
    private String ensureBucketExists(String bucketName) {
        ...
        try {
            ...
            bucketUrl = ((AmazonS3Client)s3Client).getResourceUrl(bucketName, null) + bucketName;
    ...
    private String storeProfileImageToS3(File resource, String username) {
        ...
        if (null == rootBucketUrl) {
            ...
            try {
                ...
                resourceUrl = ((AmazonS3Client)s3Client).getResourceUrl(bucketName, key);
            } catch (AmazonClientException ace) {
